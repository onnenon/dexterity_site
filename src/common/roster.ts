...
export const Roster: GuildRoster = {
  ...
  healers: [
    { name: 'Kooziecup', class: ClassEnum.MONK },
    { name: 'Kefloric', class: ClassEnum.PRIEST },
  ...
  melee: [
    { name: 'Lynxx', class: ClassEnum.DRUID },
  ...
  ranged: [
    { name: 'Kenpewz', class: ClassEnum.DRUID },
    { name: 'Lullz', class: ClassEnum.DRUID },
    { name: 'Fathomm', class: ClassEnum.WARLOCK },
